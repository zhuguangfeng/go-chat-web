...
type Activity struct {
	...
	AgeRestrict         uint8    `gorm:"column:age_restrict;type:tinyint;not null;default:0;comment:最大年龄限制" json:"ageRestrict"`
	...
	CostRestrict        uint8    `gorm:"column:cost_restrict;type:tinyint;not null;default:0;comment:费用支付方式" json:"CostRestrict"`
	Visibility          uint8    `gorm:"column:visibility;type:tinyint;not null;default:0;comment:报名可见度" json:"visibility"`
	MaxPeopleNumber     uint8    `gorm:"column:max_people_number;type:tinyint;not null;default:0;comment:最大报名人数" json:"maxPeopleNumber"`
	...
	Category            int64    `gorm:"column:category;type:int;not null;default:0;comment:活动类型" json:"category"`
